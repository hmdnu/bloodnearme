...
export const meta: MetaFunction = () => {
  return [{ title: `Register sebagai rumah sakit` }];
};
  ...
  return (
    <section className="bg-red-900 grid place-content-center h-screen">
      <section className="bg-white p-5 rounded-md flex flex-col items-center">
        ...
        <h1 className="heading-3 text-center mb-5">Register sebagai rumah sakit</h1>
          ...
          <Form method="POST" className="flex flex-col gap-2">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input placeholder="nama rumah sakit" type="text" {...field} />
                  </FormControl>
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input placeholder="alamat rumah sakit" type="text" {...field} />
                  </FormControl>
                </FormItem>
              )}
            />
